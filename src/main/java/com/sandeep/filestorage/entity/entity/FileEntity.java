...
@Entity
public class FileEntity extends FileEntityParent {
    ...
    public FileEntity(String id, String fileName, String fileType, byte[] data) {
    ...
    public FileEntity(FileEntity1 fileEntity1) {
        super(fileEntity1);
    }

    public FileEntity(FileEntity2 fileEntity1) {
        super(fileEntity1);
    }
}
